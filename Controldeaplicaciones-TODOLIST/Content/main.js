    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $.each(data, function (key, valor) {
                ...
                let prioridadtxt = valor.Prioridad;
                let prioridadbg = "";
                if (prioridadtxt == "Baja") {
                    prioridadbg = "primary";
                } else if (prioridadtxt == "Media") {
                    prioridadbg = "secondary";
                } else if (prioridadtxt == "Alta") {
                    prioridadbg = "danger";
                }
                ...
                var codigoHtml =
                    ...
                    "<td id=\"tbnote\"><span>Programar lo antes posible</span></td>" +
                    "<td id=\"tbdatec\"><span>" + moment(valor.Fechare).format('DD-MM-YYYY  HH:mm:ss') + "</span></td> " +
                    "<td id=\"tbstatus\">" +
                    "    <span class=\"badge rounded-pill bg-" + statusHex + "\">" + statusTxt + "</span>" +
                    "</td>" +
                    "<td id=\"tbdatef\"><span>" + Datefinish + "</span></td>" +
                    "<td id=\"tbprioridad\">" +
                    "    <span class=\"badge rounded-pill bg-" + prioridadbg + " text-" + prioridadbg + " bg-opacity-25\">" + prioridadtxt + "</span>" +
                    "</td>" +
                    "<td>" +
